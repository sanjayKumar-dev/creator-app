                            ...
                            <div className='form flex flex-col'>
                                <div className='m-6'>
                                    <div>
                                        ...
                                        <div className='mt-2'>
                                            <input id='email' placeholder="johndoe@gmail.com" type='email' className='block w-full rounded-md border-0 py-1.5 ps-4 shadow-sm focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6' />
                                        </div>
                                    </div>
                                    <div>
                                        <label htmlFor='password'>Password</label>
                                        <div className='mt-2'>
                                            <input id='password' placeholder="********" type='password' className='block w-full rounded-md border-0 py-1.5 ps-4 shadow-sm focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6' />
                                        </div>
                                    </div>
                                    <p>Forgot password?</p>
