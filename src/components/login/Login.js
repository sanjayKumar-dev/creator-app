    ...
    return (
        <div >
            <div className="flex h-screen">
                <div className="w-1/2 left-screen relative flex flex-col justify-between">
                    <div id='logo' className='absolute top-3 left-3'>
                    ...
                    <div id='footer' className='flex justify-between absolute bottom-5 left-0 w-full '>
                        <div>
                ...
                <div className="w-1/2 right-screen">
                    <div className='flex flex-col items-center justify-center h-full'>
                        ...
                        <div className='form flex flex-col'>
                            <div>
                                ...
                                <div className='mt-2'>
                                    <input id='email' placeholder="johndoe@gmail.com" type='email' className='block w-full rounded-md border-0 py-1.5 shadow-sm ring-1 ring-inset focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6' />
                                </div>
                            </div>
                            <div>
                                <label htmlFor='password'>Password</label>
                                <div className='mt-2'>
                                    <input id='password' placeholder="********" type='password' className='block w-full rounded-md border-0 py-1.5 shadow-sm ring-1 ring-inset focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6'/>
                                </div>
                            </div>
                            <p>Forgot password?</p>
